...
class ConclusaoOrdemProducaoTest extends BaseIntegrationTest {
    ...
    @Test
    void deveManterOrdemEmProducaoMesmoAtingindoQuantidadePlanejada() {
        ...
        // produz exatamente a quantidade planejada
        request.setQuantidadeProduzida(op.getQuantidadePlanejada());
