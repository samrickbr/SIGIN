...
@SpringBootTest
class NaoPermitirApontamentoSemQuantidadeProduzidaTest {
    ...
    @Test
    void naoDevePermitirApontamentoSemQuantidadeProduzida() {
        ...
        request.setQuantidadeProduzida(BigDecimal.ZERO);
